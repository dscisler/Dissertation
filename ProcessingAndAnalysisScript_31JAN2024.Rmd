...
ACCbyMWExp3TScongruence <- ggplot(Experiment3TS, aes(x = congruence, y = correct, fill = switch)) +
  stat_summary(
    fun = "mean", 
    geom = "bar", 
    position = position_dodge(width = 0.9),
  ...
  ggtitle(str_wrap("Accuracy of Task Switching Between Congruent by Switch Trials", width = 70)) +
  theme_minimal() +
  theme(plot.title = element_text(margin = margin(b = 5)))  # Adjust the bottom margin of the title
...
ACCbyMWExp3TSswitch <- ggplot(Experiment3TS, aes(x = switch, y = correct, fill = switch)) +
  ...
  ggtitle(str_wrap("Accuracy of Task Switching Between Switch Conditions", width = 70)) +
  theme_minimal() +
  theme(plot.title = element_text(margin = margin(b = 5)))  # Adjust the bottom margin of the title
