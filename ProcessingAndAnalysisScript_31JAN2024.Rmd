...
EXP3PostAnalysis$MW <- dplyr::recode(EXP3PostAnalysis$MWer, 'Yes' = 'MW', 'No' = 'NMW')
...
EFAanalysis$MW <- dplyr::recode(EFAanalysis$MWer, 'Yes' = 'MW', 'No' = 'NMW')
...
#Violin Plots
MR3plot <- ggplot(EFAanalysis, aes(x = Probe, y = MR3, fill = MW)) + 
  geom_violin(trim = FALSE) +
...
MR5plot <- ggplot(EFAanalysis, aes(x = MW, y = MR5, fill = Probe)) + 
  geom_violin(trim = FALSE) +
